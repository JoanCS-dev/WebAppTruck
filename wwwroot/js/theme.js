...
var getColor = function getColor(name) {
  ...
  return getComputedStyle(dom).getPropertyValue("--".concat(name)).trim();
};
...
var getTemplate = function getTemplate(event) {
  ...
  }).join(''), "\n            </ul>\n        </div>\n      ") : '', "\n  </div>\n</div>\n<div class=\"modal-footer d-flex justify-content-end bg-body-tertiary px-card border-top-0\">\n  <a href=\"").concat(document.location.href.split('/').slice(0, 5).join('/'), "/app/events/create-an-event.html\" class=\"btn btn-default btn-sm\">\n    <span class=\"fas fa-pencil-alt fs-11 mr-2\"></span> Edit\n  </a>\n  <a href='").concat(document.location.href.split('/').slice(0, 5).join('/'), "/app/events/event-detail.html' class=\"btn btn-primary btn-sm\">\n    See more details\n    <span class=\"fas fa-angle-right fs-11 ml-1\"></span>\n  </a>\n</div>\n");
};
